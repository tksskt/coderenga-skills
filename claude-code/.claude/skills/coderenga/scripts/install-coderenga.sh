...
#   REPO=tksskt/CodeRenga INSTALL_DIR=.local/bin INIT_DIR=. bash .claude/skills/coderenga/scripts/install-coderenga.sh
#   FORCE_INIT=1 bash .claude/skills/coderenga/scripts/install-coderenga.sh
set -euo pipefail
