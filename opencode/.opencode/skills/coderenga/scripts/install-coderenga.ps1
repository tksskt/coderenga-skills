...
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\.opencode\skills\coderenga\scripts\install-coderenga.ps1 -Repo tksskt/CodeRenga -InstallDir .\.local\bin -InitDir .
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\.opencode\skills\coderenga\scripts\install-coderenga.ps1 -ForceInit
param(
